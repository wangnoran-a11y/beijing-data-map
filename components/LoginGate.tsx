...
export default function LoginGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-white via-red-50/40 to-gray-100 px-6">
      <form
        onSubmit={handleLogin}
        className="w-full max-w-md rounded-3xl border border-red-100 bg-white p-8 shadow-xl"
      >
