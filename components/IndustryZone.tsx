      ...
      <div className="mx-auto w-full max-w-[1440px]">
        ...
        <div className="rounded-[30px] border border-red-100 bg-gradient-to-br from-red-50/45 via-white to-gray-50 p-4 shadow-sm sm:p-5">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
            {industries.map((item, index) => {
              ...
              return (
                <Link
                  href="/industry"
                  key={item.name}
                  className={`group relative flex min-h-[210px] flex-col overflow-hidden rounded-[24px] p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
                    isTop
                ...
                >
                  ...
                  <div className="relative flex flex-1 flex-col">
                    ...
                    <div
                      className={`mt-auto pt-6 flex items-center gap-2 text-sm font-bold ${
                        isTop
                          ? "text-white"
                          : "text-[#C41E3A]"
                      }`}
            ...
            <Link
              href="/industry"
              className="group flex min-h-[210px] flex-col items-center justify-center rounded-[24px] border border-dashed border-red-200 bg-white/80 p-5 text-center transition-all duration-300 hover:-translate-y-1 hover:border-[#C41E3A] hover:bg-red-50/40 hover:shadow-lg"
            >
              <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#C41E3A]/10 text-3xl font-light text-[#C41E3A]">
                +
              </div>

              <h3 className="text-[22px] font-black text-gray-900 group-hover:text-[#C41E3A]">
                更多专区
              </h3>

              <p className="mt-3 max-w-[240px] text-center text-[14px] leading-6 text-gray-500">
                查看更多产业数据专区与数据产品服务
              </p>
            </Link>
          </div>
