...
export const industries: IndustryItem[] = [
  {
    ...
    resources: [
      ...
      },
      {
        ...
        source: "北京市公共数据",
        sourceType: "北京市公共数据",
        href: "/authorized-resources/culture-tourism/ip",
      },
      {
        name: "人才职业技能",
        source: "北京市公共数据",
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        source: "北京市公共数据",
        sourceType: "北京市公共数据",
        href: "/authorized-resources/government-services/practice-management",
      },
      {
        name: "公共卫生监测与人群筛查数据",
        source: "北京市公共数据",
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        source: "北京市公共数据",
        sourceType: "北京市公共数据",
        href: "/authorized-resources/emergency-management/production-safety",
      },
      {
        name: "境外企业数据资源",
        source: "欧洲企业信息与信用数据",
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        source: "北京市公共数据",
        sourceType: "北京市公共数据",
        href: "/authorized-resources/green-low-carbon/utilities",
      },
      {
        name: "道路车辆管理数据",
        source: "北京市公共数据",
    ...
    resources: [
      {
        ...
        source: "北京市公共数据",
        sourceType: "北京市公共数据",
        href: "/authorized-resources/culture-tourism/tourism-resource",
      },
      {
        name: "住宿行业管理数据",
        source: "北京市公共数据",
      ...
      },
      {
        ...
        source: "北京市公共数据",
        sourceType: "北京市公共数据",
        href: "/authorized-resources/culture-tourism/public-culture",
      },
      {
        name: "知识产权",
        source: "北京市公共数据",
      ...
      },
      {
        ...
        source: "北京市公共数据",
        sourceType: "北京市公共数据",
        href: "/authorized-resources/government-services/market-monitor",
      },
      {
        name: "网证数据核验",
        source: "公安部",
